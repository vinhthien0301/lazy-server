	        ...
	        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
	            ...
	            <tr>
	                <td bgcolor="#ffffff" style="padding: 40px 40px 20px; text-align: center;">
	                    <h1 style="margin: 0; font-family: sans-serif; font-size: 24px; line-height: 125%; color: #47598A; font-weight: bold;">Hi ' . $user_name . ' </h1>
	                </td>
	            </tr>
	            <tr>
	                <td bgcolor="#ffffff" style="padding: 0 40px 40px; font-family: sans-serif; font-size: 16px; line-height: 140%; color: #919CB9; text-align: center;">
	                    <p style="margin: 0;">
	                        <b>You have a new message.</b> <br><br>
	                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
	                    </p>
	                    <br>
	                    <p style="margin: 0;">From: ' . $user_name . '</p>
	                    <p style="margin: 0;">Email: ' . $user_email . '</p>
	                    <p style="margin: 0;">Phone: ' . $user_phone . '</p>
	                    <p style="margin: 0;">Message: ' . $user_message . '</p>
	                </td>
	            </tr>
	            <tr>
